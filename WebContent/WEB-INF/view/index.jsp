			...
			<div class="row">
				<div class="col-md-4 col-sm-6 padleft-right">
					<figure class="imghvr-fold-up">
						<img src="img/ingles.jpg" class="img-responsive">
						<figcaption>
							<h3>Inglês</h3>
				...
				<div class="col-md-4 col-sm-6 padleft-right">
					<figure class="imghvr-fold-up">
						<img src="img/Photoshop.jpg" class="img-responsive">
						<figcaption>
							<h3>Photoshop</h3>
				...
				<div class="col-md-4 col-sm-6 padleft-right">
					<figure class="imghvr-fold-up">
						<img src="img/portugues.jpg" class="img-responsive">
						<figcaption>
				...
				<div class="col-md-4 col-sm-6 padleft-right">
					<figure class="imghvr-fold-up">
						<img src="img/violao.jpg" class="img-responsive">
						<figcaption>
							<h3>Violão</h3>
				...
				<div class="col-md-4 col-sm-6 padleft-right">
					<figure class="imghvr-fold-up">
						<img src="img/yoga.jpg" class="img-responsive">
						<figcaption>
							<h3>Yoga</h3>
